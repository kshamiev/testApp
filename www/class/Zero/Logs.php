...
class Zero_Logs
{
    ...
    public static function Output_Display()
    {
        ...
        $View = new Zero_View('Include_Debug');
        $View->Template_Add('Include_Debug');
...
//                    $warnings[] = str_replace(["\r", "\t"], " ", var_export($row[0], true));
    ...
    public static function Get_SourceCode($file, $line, $range_file_error)
    {
        ...
        $View = new Zero_View('Include_SourceCode');
    ...
    {
        Zero_Lib_FileSystem::File_Save_After(ZERO_PATH_LOG . '/' . $file_log . '.log', $data);
    }
}